...
<body>
    ...
    <br>
    <div class="form">
        <form method="POST" action="trackform.php"><br>
            <fieldset>
                <br>
                <legend style="padding: 10px; color: white; text-transform: uppercase; font-size: 1.6em">आवेदन आईडी
                    द्वारा आवेदन ट्रैक/Track
                    Application By application id</legend>
                <?php echo "<div>
                        <label>अपनी आवेदन संख्या दर्ज करें/<br>Enter Your Application Number :</label>
                        <input type='int' name='appNo' class='form-control'  placeholder='Enter your application number :' required />
                        </div>"; ?>
                <br><br>
                <button name="login">ट्रैक करे/Track</button>
                </legend>
            </fieldset>
        </form>

    </div>
    <div class="form" style="width:90vw;">
        ...
        <form style=" width:90vw;" method="POST" action="viewapplication.php">
            ...
            <fieldset style="width:90vw; margin:20px">
                ...
                <input style="float:right; width:100px; height:30px; color:red;" type="reset" onClick="clear()" value="Clear All Filters">
