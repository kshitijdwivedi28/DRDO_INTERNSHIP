...
if (isset($_SESSION["user_id"])) {
    ...
    $drona_email_id = $_POST["drona_email_id"];
    ...
    drona_email_id, internet_email_id, gender, qualification, research_paper, title_of_paper, paper_submitted,
    ...
    '$pin_dop_pis', '$drona_email_id', '$internet_email_id', '$gender', '$qualification', '$research_paper', '$title_of_paper',
