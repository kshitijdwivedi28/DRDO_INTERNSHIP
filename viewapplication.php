...
if (isset($_SESSION["user_id"])) {
    ...
    ?>
        <fieldset>
            <legend style="padding: 10px; color: white; text-transform: uppercase; font-size: 1.6em">आवेदन पत्र
                विवरण/Application details</legend>
            <?php
            require "conn.php";
            $query5 = mysqli_query(
                $conn,
...
ORDER BY `end_date` DESC  LIMIT 5 ";
            ...
            <table width="100%" border="1">
                ...
                <tr>
                    <td style="text-align: center;" width="25%"><?php echo $row["training_title"]; ?></td>
                    <td style="text-align: center;" width="25%"><?php echo $row["training_type"]; ?></td>
                    <td style="text-align: center;" width="25%"><?php echo $row["start_date"]; ?></td>
                    <td style="text-align: center;" width="25%"><?php echo $row["end_date"]; ?></td>
                </tr>
                <?php } ?>
            </table>
            <br />
